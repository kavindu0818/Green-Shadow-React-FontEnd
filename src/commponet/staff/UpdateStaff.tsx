...
import {updateStaff} from "../../redux/StaffSlice.ts";
import {StaffInputModel} from "./StaffInputModel.tsx";

interface UpdateStaffProps {
    staffToEdit: StaffModel;
    onClose: () => void;
}

const UpdateStaff: React.FC<UpdateStaffProps> = ({ staffToEdit, onClose }) => {
    ...
    useEffect(() => {
        if (staffToEdit) {
            ...
            setDob(staffToEdit.dob || "");
            setAddressOne(staffToEdit.address_one || "");
            setAddressTwo(staffToEdit.address_two || "");
            setAddressThree(staffToEdit.address_three || "");
            setContact(staffToEdit.contact || "");
            setEmail(staffToEdit.email || "");
            setRole(staffToEdit.role || "");
            setFieldCode(staffToEdit.fieldCode || "");
            setJoinDate(staffToEdit.join_date || "");
        }
    }, [staffToEdit]);
